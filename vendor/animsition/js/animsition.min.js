/*!
 * animsition v4.0.2
 * A simple and easy jQuery plugin for CSS animated web_page transitions.
        ...
        i = {
            init: function(a) {
                ...
                if (!o && a.browser.length > 0 && (!o || !this.length)) return "console" in window || (window.console = {}, window.console.log = function(t) {
                    return t
                }), this.length || console.log("Animsition: Element does not exist on web_page."), o || console.log("Animsition: Does not support this browser."), i.destroy.call(this);
